...
// Total intro duration must match ConstellationScene constants
const BURST_START_MS = 1500; // phase 0(300ms) + phase 1(1200ms)
      ...
      <AnimatePresence>
        {showFlash && (
          <motion.div
            ...
            transition={{ duration: 0.9, times: [0, 0.15, 0.45, 1], ease: 'easeOut' }}
            style={{
              background: `
